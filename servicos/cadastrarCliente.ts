...
export default function CadastrarCliente(clientes: Cliente[] = []): void {
    ...
    rl.question("Informe o nome do cliente: ", (nome) => {
        ...
        rl.question("Informe o nome social do cliente: ", (nomeSocial) => {
            cliente.nomeSocial = nomeSocial;

            rl.question("Data de nascimento do cliente (yyyy-mm-dd): ", (dataNascimento) => {
                cliente.dataNascimento = new Date(dataNascimento);

                rl.question("Data de cadastro do cliente (yyyy-mm-dd): ", (dataCadastro) => {
                    cliente.dataCadastro = new Date(dataCadastro);
